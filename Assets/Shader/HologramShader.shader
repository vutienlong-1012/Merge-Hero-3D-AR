...
Shader "XLong/URP/HologramShader"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_ScanScale("ScanScale", Vector) = (1,1,0,0)
		_ScanSpd("ScanSpd", Vector) = (0,0,0,0)
		_ScanSharpness("ScanSharpness", Float) = 0
		_BaseColor("BaseColor", Color) = (0,0,0,0)
		_LineColor("LineColor", Color) = (0,0,0,0)
		_Alpha("Alpha", Float) = 0
		[ASEEnd]_NoiseScale("NoiseScale", Float) = 10
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 appendResult23 = (float2(( ( _TimeParameters.x ) * _ScanSpd.x ) , ( _ScanSpd.y * ( _TimeParameters.x ) )));
				float2 texCoord15 = IN.ase_texcoord8.xy * _ScanScale + appendResult23;
				float simplePerlin2D24 = snoise( ( appendResult11 * texCoord15 )*_NoiseScale );
				simplePerlin2D24 = simplePerlin2D24*0.5 + 0.5;
				float4 lerpResult27 = lerp( _BaseColor , _LineColor , step( _ScanSharpness , simplePerlin2D24 ));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult11 = (float2(ase_grabScreenPosNorm.r , ase_grabScreenPosNorm.g));
				float2 appendResult23 = (float2(( ( _TimeParameters.x ) * _ScanSpd.x ) , ( _ScanSpd.y * ( _TimeParameters.x ) )));
				float2 texCoord15 = IN.ase_texcoord5.xy * _ScanScale + appendResult23;
				float simplePerlin2D24 = snoise( ( appendResult11 * texCoord15 )*_NoiseScale );
				simplePerlin2D24 = simplePerlin2D24*0.5 + 0.5;
				float4 lerpResult27 = lerp( _BaseColor , _LineColor , step( _ScanSharpness , simplePerlin2D24 ));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult11 = (float2(ase_grabScreenPosNorm.r , ase_grabScreenPosNorm.g));
				float2 appendResult23 = (float2(( ( _TimeParameters.x ) * _ScanSpd.x ) , ( _ScanSpd.y * ( _TimeParameters.x ) )));
				float2 texCoord15 = IN.ase_texcoord3.xy * _ScanScale + appendResult23;
				float simplePerlin2D24 = snoise( ( appendResult11 * texCoord15 )*_NoiseScale );
				simplePerlin2D24 = simplePerlin2D24*0.5 + 0.5;
				float4 lerpResult27 = lerp( _BaseColor , _LineColor , step( _ScanSharpness , simplePerlin2D24 ));
...
/*ASEBEGIN
Version=18935
1920;0;1920;1019;2184.48;481.6093;1;True;False
Node;AmplifyShaderEditor.GrabScreenPosition;10;-1392.868,-248.2654;Inherit;False;0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.NoiseGeneratorNode;24;-623.9558,10.85938;Inherit;False;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;30;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;18;-1280.956,-27.14063;Inherit;False;Property;_ScanScale;ScanScale;0;0;Create;True;0;0;0;False;0;False;1,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TextureCoordinatesNode;15;-999.468,-24.26542;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StepOpNode;25;-386.9558,20.85938;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;11;-968.868,-181.0654;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.DynamicAppendNode;23;-1193.956,269.8594;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;-1379.956,395.8594;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TimeNode;19;-1963.956,157.8594;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;30;-77.95581,39.85938;Inherit;False;Property;_Alpha;Alpha;5;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;28;-453.9558,-454.1406;Inherit;False;Property;_BaseColor;BaseColor;3;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;21;-1648.956,223.8594;Inherit;False;Property;_ScanSpd;ScanSpd;1;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-1389.956,177.8594;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;31;-794.4805,156.3907;Inherit;False;Property;_NoiseScale;NoiseScale;6;0;Create;True;0;0;0;False;0;False;10;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;27;-158.9558,-142.1406;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;26;-609.9558,-120.1406;Inherit;False;Property;_ScanSharpness;ScanSharpness;2;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;17;-767.9558,-37.14063;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ColorNode;29;-420.9558,-192.1406;Inherit;False;Property;_LineColor;LineColor;4;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=4081FD531D5915D300494AD15A14C1A613C2C3AE