...
Shader "XLong/URP/TrailShader"
{
	Properties
	{
		...
		_MaskMovement("MaskMovement", Vector) = (0,0,0,0)
		_TailMaskHeight("TailMaskHeight", Float) = 0
		[HDR]_TrailColor("TrailColor", Color) = (0,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _TrailColor;
			float2 _MaskMovement;
			float2 _NoiseMovement;
			float _TailMaskHeight;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float2 appendResult17 = (float2(( ( _TimeParameters.x ) * _MaskMovement.x ) , ( ( _TimeParameters.x ) * _MaskMovement.y )));
				float2 texCoord12 = IN.ase_texcoord3.xy * float2( 1,1 ) + appendResult17;
				float2 appendResult30 = (float2(( ( _TimeParameters.x ) * _NoiseMovement.x ) , ( ( _TimeParameters.x ) * _NoiseMovement.y )));
				float2 texCoord28 = IN.ase_texcoord3.xy * float2( 1,1 ) + appendResult30;
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( _TrailColor * IN.ase_color ).rgb;
				float Alpha = ( ( pow( ( 1.0 - IN.ase_texcoord3.xy.x ) , 1.0 ) - _TailMaskHeight ) * tex2D( _MaskTexture, texCoord12 ) * tex2D( _NoiseTex, texCoord28 ) ).r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult17 = (float2(( ( _TimeParameters.x ) * _MaskMovement.x ) , ( ( _TimeParameters.x ) * _MaskMovement.y )));
				float2 texCoord12 = IN.ase_texcoord2.xy * float2( 1,1 ) + appendResult17;
				float2 appendResult30 = (float2(( ( _TimeParameters.x ) * _NoiseMovement.x ) , ( ( _TimeParameters.x ) * _NoiseMovement.y )));
				float2 texCoord28 = IN.ase_texcoord2.xy * float2( 1,1 ) + appendResult30;
				
				float Alpha = ( ( pow( ( 1.0 - IN.ase_texcoord2.xy.x ) , 1.0 ) - _TailMaskHeight ) * tex2D( _MaskTexture, texCoord12 ) * tex2D( _NoiseTex, texCoord28 ) ).r;
				float AlphaClipThreshold = 0.5;
				float AlphaClipThresholdShadow = 0.5;
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 appendResult17 = (float2(( ( _TimeParameters.x ) * _MaskMovement.x ) , ( ( _TimeParameters.x ) * _MaskMovement.y )));
				float2 texCoord12 = IN.ase_texcoord.xy * float2( 1,1 ) + appendResult17;
				float2 appendResult30 = (float2(( ( _TimeParameters.x ) * _NoiseMovement.x ) , ( ( _TimeParameters.x ) * _NoiseMovement.y )));
				float2 texCoord28 = IN.ase_texcoord.xy * float2( 1,1 ) + appendResult30;
				
				surfaceDescription.Alpha = ( ( pow( ( 1.0 - IN.ase_texcoord.xy.x ) , 1.0 ) - _TailMaskHeight ) * tex2D( _MaskTexture, texCoord12 ) * tex2D( _NoiseTex, texCoord28 ) ).r;
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 appendResult17 = (float2(( ( _TimeParameters.x ) * _MaskMovement.x ) , ( ( _TimeParameters.x ) * _MaskMovement.y )));
				float2 texCoord12 = IN.ase_texcoord1.xy * float2( 1,1 ) + appendResult17;
				float2 appendResult30 = (float2(( ( _TimeParameters.x ) * _NoiseMovement.x ) , ( ( _TimeParameters.x ) * _NoiseMovement.y )));
				float2 texCoord28 = IN.ase_texcoord1.xy * float2( 1,1 ) + appendResult30;
				
				surfaceDescription.Alpha = ( ( pow( ( 1.0 - IN.ase_texcoord1.xy.x ) , 1.0 ) - _TailMaskHeight ) * tex2D( _MaskTexture, texCoord12 ) * tex2D( _NoiseTex, texCoord28 ) ).r;
				surfaceDescription.AlphaClipThreshold = 0.5;
...
/*ASEBEGIN
Version=18935
0;0;1920;1019;3355.59;1297.779;2.2;True;True
Node;AmplifyShaderEditor.TimeNode;29;-2822.147,-384.2591;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TimeNode;14;-3075.774,410.1028;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;13;-2826.274,412.5029;Inherit;False;Property;_MaskMovement;MaskMovement;2;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;34;-2548.606,-406.5179;Inherit;False;Property;_NoiseMovement;NoiseMovement;5;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;32;-2311.147,-302.2589;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-2573.774,385.1028;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;16;-2564.774,492.103;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;18;-2747.653,-205.5515;Inherit;True;0;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;31;-2320.147,-409.2591;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;30;-2158.147,-398.2591;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-2412.224,32.84595;Inherit;False;Constant;_TailMaskPow;TailMaskPow;3;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;19;-2463.524,-182.8541;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;17;-2411.774,396.1028;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;24;-2144.664,73.09782;Inherit;False;Property;_TailMaskHeight;TailMaskHeight;3;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;12;-2247.956,353.9172;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PowerNode;20;-2191.824,-162.054;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;28;-1994.33,-440.4447;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;10;-1685.6,-298.286;Inherit;True;Property;_NoiseTex;NoiseTex;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;11;-1969.214,320.9911;Inherit;True;Property;_MaskTexture;MaskTexture;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleSubtractOpNode;23;-1926.907,-118.1394;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;26;-833.3812,-335.3894;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.VertexColorNode;35;-1097.103,-224.0474;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;27;-1265.681,-473.8893;Inherit;False;Property;_TrailColor;TrailColor;4;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;25;-1408.647,55.34166;Inherit;False;3;3;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;XLong/URP/TrailShader;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;637973368134260926;  Blend;0;0;Two Sided;1;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=94AA3F3BE65D3EEBCD17F673FD919D7BC5C53FDA